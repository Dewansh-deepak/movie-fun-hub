    ...
    const fetchTrendingVideos = async () => {
      const { data, error } = await supabase
        ...
        .select(`
          ...
          creator:profiles!videos_creator_id_fkey(display_name, avatar_url)
        `)
              ...
              >
                ...
                <div className="flex items-center justify-center w-8">
                  <span className={`font-display text-2xl ${
                    index < 3 ? "text-gradient" : "text-muted-foreground"
                  }`}>
                    {index + 1}
                  </span>
                </div>
                ...
                <div className="relative w-32 aspect-video rounded-lg overflow-hidden flex-shrink-0">
                  ...
                  {index < 3 && (
                    <div className="absolute top-1 left-1 px-1.5 py-0.5 rounded bg-accent text-[10px] font-bold text-white flex items-center gap-0.5">
                ...
                <div className="flex-1 text-left">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <div className="w-5 h-5 rounded-full bg-gradient-instagram flex items-center justify-center text-[10px] text-white font-bold">
